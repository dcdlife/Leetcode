...
if __name__ == "__main__":
    ...
    print(su.wordBreak('leetcode', ['leet', 'leetc', 'leetco', 'code']))
    print(su.wordBreak(s = "applepenapple", wordDict = ["apple", "pen"]))
    print(su.wordBreak(s = "catsandog", wordDict = ["cats", "dog", "sand", "and", "cat"]))
    print(su.wordBreak("aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaab",["a","aa","aaa","aaaa","aaaaa","aaaaaa","aaaaaaa","aaaaaaaa","aaaaaaaaa","aaaaaaaaaa"]))
